...
layout=[
    ...
    [sg.Text("weight"),sg.Input(key="w1",right_click_menu=grp_rclick_menu["w1"]),sg.Text("vae"),sg.Radio("",key="v1",group_id='destination')],
    [sg.Text("ckpt2"), sg.Input(key="ckpt2",right_click_menu=grp_rclick_menu["ckpt2"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w2",right_click_menu=grp_rclick_menu["w2"]),sg.Text("vae"),sg.Radio("",key="v2",group_id='destination')],
    [sg.Text("ckpt3"), sg.Input(key="ckpt3",right_click_menu=grp_rclick_menu["ckpt3"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w3",right_click_menu=grp_rclick_menu["w3"]),sg.Text("vae"),sg.Radio("",key="v3",group_id='destination')],
    [sg.Text("ckpt4"), sg.Input(key="ckpt4",right_click_menu=grp_rclick_menu["ckpt4"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w4",right_click_menu=grp_rclick_menu["w4"]),sg.Text("vae"),sg.Radio("",key="v4",group_id='destination')],
    [sg.Text("ckpt5"), sg.Input(key="ckpt5",right_click_menu=grp_rclick_menu["ckpt5"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w5",right_click_menu=grp_rclick_menu["w5"]),sg.Text("vae"),sg.Radio("",key="v5",group_id='destination')],
    [sg.Text("ckpt6"), sg.Input(key="ckpt6",right_click_menu=grp_rclick_menu["ckpt6"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w6",right_click_menu=grp_rclick_menu["w6"]),sg.Text("vae"),sg.Radio("",key="v6",group_id='destination')],
    [sg.Text("ckpt7"), sg.Input(key="ckpt7",right_click_menu=grp_rclick_menu["ckpt7"]),sg.FileBrowse( file_types=(('ckpt file', '.safetensors'),))],
    [sg.Text("weight"),sg.Input(key="w7",right_click_menu=grp_rclick_menu["w7"]),sg.Text("vae"),sg.Radio("",key="v7",group_id='destination')],
