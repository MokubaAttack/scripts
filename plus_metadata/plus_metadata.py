...
col1=[
    [sg.Text("prompt")],
    [sg.Multiline(ivs["pr"], size=(40, 5),key="pr",right_click_menu=grp_rclick_menu["pr"])]
]
col2=[
    [sg.Text("negative prompt")],
    [sg.Multiline(ivs["ne"], size=(40, 5),key="ne",right_click_menu=grp_rclick_menu["ne"])]
]
...
layout=[
    ...
    [sg.Text("Steps"), sg.Input(ivs["st"],key="st",right_click_menu=grp_rclick_menu["st"])],
    [sg.Text("Sampler"), sg.Combo(default_value=ivs["sa"],values=choices,key="sa")],
    [sg.Text("CFG scale"), sg.Input(ivs["cf"],key="cf",right_click_menu=grp_rclick_menu["cf"])],
    [sg.Text("Seed"), sg.Input(ivs["se"],key="se",right_click_menu=grp_rclick_menu["se"])],
    [sg.Text("Clip skip"), sg.Input(ivs["cl"],key="cl",right_click_menu=grp_rclick_menu["cl"])],
    [sg.Text("ckpt modelVersionId"), sg.Input(ivs["ckpt"],key="ckpt",right_click_menu=grp_rclick_menu["ckpt"])],
    [sg.Text("lora1 modelVersionId"), sg.Input(ivs["lora1"],key="lora1",right_click_menu=grp_rclick_menu["lora1"]),sg.Text("weight"), sg.Input(ivs["w1"],key="w1",right_click_menu=grp_rclick_menu["w1"])],
    [sg.Text("lora2 modelVersionId"), sg.Input(ivs["lora2"],key="lora2",right_click_menu=grp_rclick_menu["lora2"]),sg.Text("weight"), sg.Input(ivs["w2"],key="w2",right_click_menu=grp_rclick_menu["w2"])],
    [sg.Text("lora3 modelVersionId"), sg.Input(ivs["lora3"],key="lora3",right_click_menu=grp_rclick_menu["lora3"]),sg.Text("weight"), sg.Input(ivs["w3"],key="w3",right_click_menu=grp_rclick_menu["w3"])],
    [sg.Text("lora4 modelVersionId"), sg.Input(ivs["lora4"],key="lora4",right_click_menu=grp_rclick_menu["lora4"]),sg.Text("weight"), sg.Input(ivs["w4"],key="w4",right_click_menu=grp_rclick_menu["w4"])],
    [sg.Text("embed1 modelVersionId"), sg.Input(ivs["embed1"],key="embed1",right_click_menu=grp_rclick_menu["embed1"])],
    [sg.Text("embed2 modelVersionId"), sg.Input(ivs["embed2"],key="embed2",right_click_menu=grp_rclick_menu["embed2"])],
    [sg.Text("embed3 modelVersionId"), sg.Input(ivs["embed3"],key="embed3",right_click_menu=grp_rclick_menu["embed3"])],
    [sg.Text("embed4 modelVersionId"), sg.Input(ivs["embed4"],key="embed4",right_click_menu=grp_rclick_menu["embed4"])],
    [sg.Button('RUN', key='RUN'),sg.Button('EXIT', key='EXIT'),sg.Button('SAVE', key='SAVE'),sg.Button('LOAD', key='LOAD')]
]
